    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          {/* Command box */}
          <div className="relative w-full max-w-lg mx-4 rounded-xl bg-white dark:bg-stone-900 shadow-2xl border border-stone-200 dark:border-stone-800 overflow-hidden animate-in fade-in-0 zoom-in-95 duration-100">
            <Command className=" [&_[cmdk-input-wrapper]]:border-0 [&_[cmdk-input-wrapper]]:bg-transparent [&_[cmdk-input]]:h-12 [&_[cmdk-list]]:max-h-72 [&_[cmdk-item]]:rounded-lg [&_[cmdk-item]]:mx-1 [&_[cmdk-item]]:my-0.5">
              <div className="flex items-center border-b border-stone-100 dark:border-stone-800 px-4">
                ...
                <button
                  ...
                  className="p-1 rounded-md hover:bg-stone-100 dark:hover:bg-stone-800 text-stone-400 dark:text-stone-500"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
              ...
              <Command.List className="p-2 overflow-y-auto max-h-72">
                ...
                <Command.Group
                  heading="Navigasi"
                  className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-stone-400 dark:[&_[cmdk-group-heading]]:text-stone-500"
                >
                  <Command.Item
                    onSelect={() => navigate("/")}
                    className="flex items-center gap-2 px-2 py-2 text-sm rounded-lg cursor-pointer text-stone-700 dark:text-stone-300 data-[selected=true]:bg-stone-100 dark:data-[selected=true]:bg-stone-800"
                  >
